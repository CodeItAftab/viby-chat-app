...
export function EmptyState({ activeSection }: EmptyStateProps) {
  ...
  const actionPath = activeSection === "chats" ? "/friends" : "/discover";
    ...
    <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-background via-background/95 to-background">
      <div className="text-center max-w-sm mx-auto px-6">
        ...
        {state.action && state.actionIcon && (
          <Button
            className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-6 py-2.5 rounded-2xl font-semibold shadow-lg shadow-blue-500/25 transition-all duration-300 hover:shadow-blue-500/40"
